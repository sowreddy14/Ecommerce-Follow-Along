...
function Navbar({ hideButtons = false }) {
  ...
  return (
    <nav className="h-16 fixed top-0 left-0 right-0 z-50 bg-gray-900 text-white shadow-md">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center h-full">
        ...
        >
          Game <span className="text-yellow-300">Universe</span>
        </h1>
        ...
        <div className="hidden md:flex items-center space-x-6">
          ...
          {!hideButtons && (
            <button
              ...
              className="text-lg cursor-pointer font-semibold hover:text-yellow-300 transition"
            >
              Add Product
            </button>
          )}
      ...
      {/* Mobile Menu */}
      {isOpen && (
        <div className="md:hidden bg-gray-800 absolute top-16 left-0 w-full py-4 shadow-lg z-40">
          <div className="flex flex-col space-y-4 items-center">
            ...
            {user ? (
              <>
                ...
                <button
                  onClick={handleLogout}
                  className="text-lg font-semibold text-red-400 hover:text-red-300 transition"
                >
                  Logout
                </button>
              </>
